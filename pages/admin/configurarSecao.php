...
if (!$secaoModel->getSecao($_GET['id'])) {
...
$secaoEditar =  $secaoModel->getSecao($id);

$icon_atual = $secaoEditar->icon;

$subsecao_atual = -1;
$secao_atual = $id;

$configurar_secao_id = $secao_atual;
            ...
            <div class="container">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <h3>Configurar Seção: <i class="nav-icon <?= $icon_atual ?> icon-menu" style='font-size:24px;'></i> <?= $secaoEditar->titulo ?></h3>
                        </div>
                    </div>

                    <div class="card-body">

                        <form action="../../backend/configurarSecao.php" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-5">
                                    ...
                                    <p style="display: inline;">
                                        <i class="nav-icon <?= $icon_atual ?> icon-menu" style='font-size:30px;'></i>
                            ...
                            <input type="hidden" name="url_destino" value="../pages/admin/index.php">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form action="../../backend/excluirSecao.php" method="post">
                                <input type="hidden" name="url_destino" value="../pages/admin/">
                                <input type="hidden" name="id" value="<?= $secaoEditar->id ?>">
                                <input type="hidden" name="ordem" value="<?= $secaoEditar->ordem ?>">
